...
query_IDB <- function(df_lncRNA_genes, 
  ...
  ## Connect to the IDB
  IDB_path <- "/home/sruiz/PROJECTS/splicing-project-app/introverse/dependencies/introverse.sqlite"
...
df_lncRNA_genes_IDB_tidy <- filter_IDB_data_by_threshold(df_lncRNA_genes_IDB, 
                                                         ...
                                                         threshold)
getwd()
saveRDS(object = df_lncRNA_genes_IDB_tidy, 
        file = "~/PROJECTS/splicing-project-recount3/paper_figures/GBA_paper_thr5.rds")
...
## Load file
threshold <- 5
df_lncRNA_genes_IDB_tidy <- readRDS(file = "~/PROJECTS/splicing-project-recount3/paper_figures/GBA_paper_thr5.rds")
...
file_name <- paste0("paper_figures/GBA_paper_genes_threshold_5.png")
ggplot2::ggsave(filename = file_name, width = 183, height = 183, units = "mm", dpi = 300)

## EMIL'S GRAPH  --------------------------------

prop_genes_threshold_5_IDB_plot <- df_lncRNA_genes_IDB_tidy %>% 
...
ggsave(
  ...
  filename = "paper_figures/GBA_paper_genes_threshold_5_v2.png", 
  width = 6, 
  height = 5, 
  dpi = 600
)
