...
for (cluster in gtex_tissues[6]) { # tissue <- gtex_tissues[11]
...
for (tissue in gtex_tissues[6]) {
  
  cat('\n') 
  cat("####", tissue, "\n")
  
  folder_name <- paste0("/home/sruiz/PROJECTS/splicing-project/splicing-recount3-projects/", 
                        project_id, "/results/pipeline3/missplicing-ratio/", tissue, "/v", gtf_version, "/")

  plot_distances_modulo(cluster = tissue,
