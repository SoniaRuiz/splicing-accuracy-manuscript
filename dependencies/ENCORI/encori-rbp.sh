#!/bin/bash
# Loop each RBP and download data from ENCORI
...
do
  ...
  do
    ...
    #curl "https://rna.sysu.edu.cn/encori/api/RBPTarget/?assembly=hg38&geneType=mRNA&RBP=all&clipExpNum=1&pancancerNum=0&target=all&cellType=$celltype" > "ENCORI_hg38_RBPTarget_"$celltype".txt"
